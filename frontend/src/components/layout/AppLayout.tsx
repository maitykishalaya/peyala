  ...
  return (
    <div className="flex min-h-screen overflow-hidden bg-gray-50 dark:bg-gray-950">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Topbar */}
        <header className="sticky top-0 z-20 h-14 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 flex items-center gap-4 px-3 sm:px-4 flex-shrink-0">
        ...
        {/* Content */}
        <main className="flex-1 overflow-y-auto p-3.5 sm:p-6 pb-28 md:pb-8 safe-bottom">
          {children}
        </main>
